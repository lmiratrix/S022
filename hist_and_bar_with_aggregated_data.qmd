...
editor: visual
---
# Plotting aggregate data with ggPlot {#sec-plot-aggregate}
...
In particular, this handout demonstrates how to create histograms with ggplot when the data have already been aggregated or tallied.
