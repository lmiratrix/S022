...
How do you cleaning excel files? This "handout" (actually an R script) loads in a csv file made from a dirty excel file and cleans it. This is a data cleaning problem I have seen a few final project groups face. Download these files, look at the original csv file, and then source the script and see what you get! 

Resources

- [The dataset](data/sample_ugly_data.csv)
- [The script](scripts/data_cleaning_example.R)

Here is the code, for reference.  But download the script!
