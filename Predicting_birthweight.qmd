...
If you are pasting this code into your own computer, you can [download lbw_holdout.csv](data/lbw_holdout.csv) and [lbw_training.csv](data/lbw_training.csv) from the course website.
